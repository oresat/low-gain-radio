...
#define SCGC_TPM0_CLK (1 << 24)
#define SCGC_TPM1_CLK (1 << 25)
#define SCGC_TPM2_CLK (1 << 26)
#define SCGC_ADC0_CLK (1 << 27)
#define SCGC_RTC_CLK (1 << 29)
