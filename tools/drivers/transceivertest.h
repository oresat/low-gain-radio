...
void trans_set_automode_enter_cond(uint8_t * enter_cond);
void trans_set_automode_exit_cond(uint8_t * exit_cond);
void trans_set_automode_intermed_cond(uint8_t * intermed_cond);
